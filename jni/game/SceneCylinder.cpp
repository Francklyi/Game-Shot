...
bool SceneCylinder::loadData()
{

}

void SceneCylinder::init()
{
	pLR->setPhyScene(pPScene);
	pEnemyGroup->addATeamToGame();
}

void SceneCylinder::reset()
{
...
void SceneCylinder::updateMoveLess()
{
	//pG_floor->pTransform->pTOmatrix->mMatrixQueue.back()[12]+=pfMoveStepNow[0];
	//pG_floor->pTransform->pTOmatrix->mMatrixQueue.back()[13]+=pfMoveStepNow[1];
	//pG_floor->pTransform->pTOmatrix->mMatrixQueue.back()[14]+=pfMoveStepNow[2];
...
void SceneCylinder::setType(int type_)
{
	type=type_;
}

void SceneCylinder::setFloor(Graph* pGraph)
{
	pG_floor=pGraph;
...
void SceneCylinder::setPLR(LeadRole *pLR_)
{
	pLR=pLR_;
}

void SceneCylinder::setPhyScene(PhyScene *pPScene_)
{
	pPScene=pPScene_;
}

void SceneCylinder::addEnemyRace( GraphRace * pER)
{
	vEnemyRace.push_back(pER);
}

void SceneCylinder::loadData(float *pdata)
{
...
void SceneCylinder::setfloorPhy(float *pf)
{
...
void SceneCylinder::getMovesteps()
{
	pfMoveStepNow=pG_floor->pMovepath->getMovestep();//pfMoveSteps
}

void SceneCylinder::renewPhyScene()
{
	//LOGI("renew 1");
...
void SceneCylinder::setfloorPhyNew()
{

}

void SceneCylinder::updateOneEnemy(ArmyRole* pAR)
{
...
int SceneCylinder::inScreenSum=0;
float *SceneCylinder::f4=new float[4];

float *SceneCylinder::f32=new float[32];

bool SceneCylinder::isInScreen()
{
...
void SceneCylinder::toNext()
{

}

void SceneCylinder::toPre()
{
